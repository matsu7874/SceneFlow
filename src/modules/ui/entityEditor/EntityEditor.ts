...
export class EntityEditor {
   ...
   */
  createEntity(type: 'person'): PersonEntity
  createEntity(type: 'location'): LocationEntity
  createEntity(type: 'item'): ItemEntity
  createEntity(type: 'information'): InformationEntity
