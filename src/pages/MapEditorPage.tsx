              ...
              {showGuide && (
                <div className="guide-content">
                  <div className="guide-section">
                    ...
                    <ul>
                      <li>
                        <strong>ダブルクリック</strong>: 新規ノード作成
                      </li>
                      <li>
                        <strong>ドラッグ</strong>: キャンバス移動
                      </li>
                      <li>
                        <strong>マウスホイール</strong>: ズーム
                      </li>
                      <li>
                        <strong>右クリック</strong>: コンテキストメニュー
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="guide-section">
                    ...
                    <ul>
                      <li>
                        <strong>クリック</strong>: ノード選択
                      </li>
                      <li>
                        <strong>Shift+クリック</strong>: 複数選択
                      </li>
                      <li>
                        <strong>Shift+ドラッグ</strong>: 範囲選択
                      </li>
                      <li>
                        <strong>ノードをドラッグ</strong>: 位置変更
                      </li>
                      <li>
                        <strong>ノードをダブルクリック</strong>: ノード編集
                      </li>
                      <li>
                        <strong>Delete/Backspace</strong>: 選択中のノード削除
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="guide-section">
                    ...
                    <ul>
                      <li>
                        <strong>Ctrl/Cmd+ノードクリック</strong>: 接続開始
                      </li>
                      <li>
                        <strong>Connectボタン → ノードクリック</strong>: 接続モード
                      </li>
                      <li>
                        <strong>Delete/Backspace</strong>: 選択中の接続削除
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="guide-section">
                    ...
                    <ul>
                      <li>
                        <strong>Ctrl/Cmd+Z</strong>: 元に戻す
                      </li>
                      <li>
                        <strong>Ctrl/Cmd+Shift+Z</strong>: やり直し
                      </li>
                      <li>
                        <strong>Ctrl/Cmd+A</strong>: すべて選択
                      </li>
                      <li>
                        <strong>Esc</strong>: 操作キャンセル
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="guide-section">
                    ...
                    <ul>
                      <li>
                        <strong>Grid</strong>: グリッド配置
                      </li>
                      <li>
                        <strong>Circle</strong>: 円形配置
                      </li>
                      <li>
                        <strong>Force-Directed</strong>: 力学的配置
                      </li>
                    </ul>
                  </div>
                </div>
